...
func New(
	router chi.Router,
	log *slog.Logger,
	usersRpc userspb.UserServiceClient,
	verificationRpc userspb.VerificationServiceClient,
	sessionActionRpc userspb.SessionActionServiceClient,
	sessionsRpc sessionspb.SessionsServiceClient,
	cfg *Config,
) *controller {
	return &controller{
		router:        router,
		...
		sessionAction: sessionActionRpc,
