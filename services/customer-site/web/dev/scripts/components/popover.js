import '../vendor/floatingui_dom.js';
import '../vendor/floatingui_core.js';
...
(function () {
	...
	function openPopoverWithTrigger(trigger) {
		...
		for (const openPopover of document.querySelectorAll(
			'[data-tui-popover-exclusive="true"][data-tui-popover-open="true"]'
		)) {
