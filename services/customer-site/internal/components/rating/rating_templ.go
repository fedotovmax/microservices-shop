...
func Rating(props *Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 54, Col: 12}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 57, Col: 62}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 58, Col: 62}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 59, Col: 59}
		}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 61, Col: 32}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 63, Col: 65}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 1, Col: 0}
		}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 76, Col: 17}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 77, Col: 40}
			}
			...
			if p.Form != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 79, Col: 18}
				}
...
func Group(props *GroupProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 96, Col: 12}
			}
...
func Item(props *ItemProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 115, Col: 12}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/rating/rating.templ`, Line: 118, Col: 47}
		}
...
func ratingIcon(style Style, filled bool, value float64) templ.Component {
	if style == StyleEmoji {
		if filled {
			switch {
			case value <= 1:
				return icon.Icon(&icon.Props{Icon: icon.IconAngry})
			case value <= 2:
				return icon.Icon(&icon.Props{Icon: icon.IconFrown})
			case value <= 3:
				return icon.Icon(&icon.Props{Icon: icon.IconMeh})
			case value <= 4:
				return icon.Icon(&icon.Props{Icon: icon.IconSmile})
			default:
				return icon.Icon(&icon.Props{Icon: icon.IconLaugh})
			}
		}
		return icon.Icon(&icon.Props{Icon: icon.IconMeh})
	}
	...
	switch style {
	case StyleHeart:
		iconProps.Icon = icon.IconHeart
		return icon.Icon(iconProps)
	default:
		iconProps.Icon = icon.IconStar
		return icon.Icon(iconProps)
	}
}
