...
func Button(props *Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var hasClick bool
		rawClick, ok := p.Attributes["onclick"]
		if ok {
		...
		if p.Href != "" && !p.Disabled {
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 65, Col: 13}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 67, Col: 31}
			}
			...
			if p.Target != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 69, Col: 21}
				}
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 91, Col: 13}
				}
			...
			if p.Type != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 107, Col: 25}
				}
			...
			if p.Form != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/components/button/button.templ`, Line: 110, Col: 17}
				}
			...
			if hasClick {
				...
				var templ_7745c5c3_Var12 templ.ComponentScript = onclick
