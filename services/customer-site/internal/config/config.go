...
func LoadAppConfig() (*AppConfig, error) {
	...
	apiGatewayAddr, err := envconfig.GetEnv("API_GATEWAY_ADDR")
	...
	customersAppToken, err := envconfig.GetEnv("CUSTOMER_APP_TOKEN")
	...
	config := &AppConfig{
		Env:               appEnv,
		Port:              port,
		ApiGatewayAddr:    apiGatewayAddr,
		TranslationPath:   translationPath,
		CustomersAppToken: customersAppToken,
	}
