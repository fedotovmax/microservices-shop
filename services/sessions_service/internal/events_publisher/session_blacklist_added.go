...
func (p *publisher) SessionBlacklistAdded(ctx context.Context, payload events.SessionBlacklistAddedEventPayload) error {

	const op = "events_publisher.SessionBlacklistAdded"
