...
type Server struct {
	addr string
	svc  sessionspb.SessionsServiceServer
	grpc *grpc.Server
}

func New(cfg Config, svc sessionspb.SessionsServiceServer, opt ...grpc.ServerOption) *Server {
	return &Server{
		addr: cfg.Addr,
		svc:  svc,
...
func (s *Server) Start() error {
	...
	sessionspb.RegisterSessionsServiceServer(s.grpc, s.svc)
