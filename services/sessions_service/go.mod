module github.com/fedotovmax/microservices-shop/sessions_service

go 1.25.4

require (
	github.com/IBM/sarama v1.46.3
	github.com/fedotovmax/envconfig v1.0.1
	github.com/fedotovmax/grpcutils v1.0.9
	github.com/fedotovmax/kafka-lib v1.0.9
	github.com/fedotovmax/microservices-shop-protos v1.0.29
