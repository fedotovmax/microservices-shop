...
func (p *postgresAdapter) UpdateEmailVerifyLinkByUserID(ctx context.Context, uid string) (*domain.EmailVerifyLink, error) {
	...
	row := tx.QueryRow(ctx, updateEmailVerifyLinkByUserIDQuery, uid)
